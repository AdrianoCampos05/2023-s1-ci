...
def test_8_chars_with_invalid_special_character_password_should_raise_exception():
    # given
    validator = PasswordValidator(content="aBc123?/")
    with pytest.raises(IllegalCharacterException):  # then
        # when
        validator.password_validate()
